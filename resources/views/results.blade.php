...
<section class="cta-section">
  <div class="cta-inner reveal">
    ...
    <div class="cta-buttons">
      <a href="/contact" class="btn-gradient"><span>Send 5 Test Clients</span> <span class="arrow">&rarr;</span></a>
...
<footer>
  ...
  <div class="footer-grid">
    ...
    <div class="footer-col">
      ...
      <ul>
        ...
        <li><a href="/#services">Bureau Follow-Up</a></li>
        <li><a href="/#services">CFPB / FTC Documentation</a></li>
        <li><a href="/#services">Weekly Reporting</a></li>
      </ul>
    </div>
    <div class="footer-col">
      <h5>Company</h5>
  ...
  <div class="footer-bottom">
    <span>&copy; 2026 APEX GROWTH SYSTEMS LLC</span>
