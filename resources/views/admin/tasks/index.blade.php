...
<style>
    ...
    .tv-stat { background:var(--pro-panel,var(--card-bg,#fff)); border:1px solid var(--pro-line,var(--line,#e6ebf2)); border-radius:14px; padding:16px 18px; position:relative; overflow:hidden; }
    ...
    .tv-stat-label { font-size:11.5px; font-weight:800; letter-spacing:.04em; text-transform:uppercase; color:var(--pro-muted,var(--muted,#64748b)); }
    .tv-stat-val { font-size:30px; font-weight:800; line-height:1; color:var(--pro-text,var(--text,#0f172a)); }
    .tv-stat-sub { font-size:12px; color:var(--pro-muted,var(--muted,#64748b)); margin-top:5px; }

    .tv-day { margin-bottom:14px; padding:0; overflow:hidden; }
    .tv-day-head { display:flex; align-items:center; justify-content:space-between; gap:10px; padding:13px 18px; border-bottom:1px solid var(--pro-line,var(--line,#e6ebf2)); background:var(--pro-bg,var(--panel-alt,#f8fafc)); }
    .tv-day-date { display:flex; align-items:center; gap:9px; font-size:14px; font-weight:800; color:var(--pro-text,var(--text,#0f172a)); }
    .tv-day-dot { width:9px; height:9px; border-radius:50%; background:#6366f1; box-shadow:0 0 0 3px rgba(99,102,241,.18); }
    .tv-day-count { font-size:12px; font-weight:700; color:var(--pro-muted,var(--muted,#64748b)); }
    .tv-list { list-style:none; margin:0; padding:4px 0; }
    .tv-item { display:flex; align-items:flex-start; gap:12px; padding:11px 18px; }
    .tv-item + .tv-item { border-top:1px solid var(--pro-line,var(--line,#eef2f7)); }
    ...
    .tv-name { font-size:14px; font-weight:700; color:var(--pro-text,var(--text,#0f172a)); }
    .tv-round { font-size:11px; font-weight:700; color:#4338ca; background:#e0e7ff; padding:2px 9px; border-radius:999px; }
    .tv-va { font-size:11px; font-weight:700; color:#0e7490; background:#cffafe; padding:2px 9px; border-radius:999px; }
    .tv-tasks { font-size:12.5px; color:var(--pro-muted,var(--muted,#64748b)); margin-top:3px; }
    .tv-time { flex:0 0 auto; font-size:12px; font-weight:700; color:var(--pro-muted,var(--muted,#64748b)); white-space:nowrap; margin-top:2px; }
</style>
@endpush
@endsection
