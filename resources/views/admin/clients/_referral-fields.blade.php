...
@push('head')
<style>
    .ref-box { margin: 8px 0; padding: 16px 18px; background: #f8fafc; border: 1px solid #e6ebf2; border-radius: 14px; }
    .ref-box-title { display: flex; align-items: center; gap: 8px; font-size: 12px; font-weight: 800; letter-spacing: .06em; text-transform: uppercase; color: #64748b; margin-bottom: 14px; }
    .ref-box-title svg { width: 15px; height: 15px; color: #7c3aed; }

    /* toggle card */
    .ref-toggle { display: flex; align-items: flex-start; gap: 13px; background: #fff; border: 1px solid #e6ebf2; border-radius: 12px; padding: 13px 15px; cursor: pointer; transition: border-color .12s, box-shadow .12s; }
    .ref-toggle:hover { border-color: #cbd5e1; }
    ...
    .ref-track { position: absolute; inset: 0; background: #cbd5e1; border-radius: 999px; transition: background .18s; }
    .ref-track::before { content: ''; position: absolute; top: 3px; left: 3px; width: 21px; height: 21px; background: #fff; border-radius: 50%; box-shadow: 0 1px 3px rgba(15,23,42,.28); transition: transform .18s; }
    ...
    .ref-toggle-title { font-weight: 700; font-size: 14px; color: #0f172a; }
    .ref-toggle-desc { font-size: 12.5px; color: #64748b; line-height: 1.4; }

    /* referred-by pills (single select) */
    .ref-refby { margin-top: 14px; }
    .ref-refby-label { font-weight: 700; font-size: 13.5px; color: #0f172a; margin-bottom: 9px; }
    .ref-hint { font-weight: 400; color: #94a3b8; }
    ...
    .ref-pill-face { display: inline-flex; align-items: center; gap: 9px; padding: 9px 15px 9px 12px; border: 1.5px solid #e2e8f0; border-radius: 999px; background: #fff; font-weight: 600; font-size: 13.5px; color: #475569; transition: all .12s; }
    .ref-dot { width: 16px; height: 16px; border-radius: 50%; border: 2px solid #cbd5e1; flex: none; transition: all .12s; }
    .ref-pill:hover .ref-pill-face { border-color: #c7d2fe; }
    .ref-pill input:checked + .ref-pill-face { border-color: #4f46e5; background: #eef2ff; color: #3730a3; box-shadow: 0 0 0 3px rgba(79,70,229,.12); }
    .ref-pill input:checked + .ref-pill-face .ref-dot { border-color: #4f46e5; background: #4f46e5; box-shadow: inset 0 0 0 3px #fff; }
